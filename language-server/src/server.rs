...
pub trait LanguageServer {
    ...
    async fn initialized(&self, params: InitializedParams, client: LspClient) {}
    ...
    async fn shutdown(&self, params: (), client: LspClient) -> Result<()> {
        Ok(())
    }
    ...
    async fn exit(&self, params: (), client: LspClient) {}
    ...
    async fn did_open(&self, params: DidOpenTextDocumentParams, client: LspClient) {}
    ...
    async fn did_change(&self, params: DidChangeTextDocumentParams, client: LspClient) {}
    ...
    async fn will_save(&self, params: WillSaveTextDocumentParams, client: LspClient) {}
    ...
    async fn did_save(&self, params: DidSaveTextDocumentParams, client: LspClient) {}
    ...
    async fn did_close(&self, params: DidCloseTextDocumentParams, client: LspClient) {}
    ...
    async fn code_lens(&self, params: CodeLensParams, client: LspClient) -> Result<Vec<CodeLens>> {
        Ok(Vec::new())
    }
    ...
    async fn code_lens_resolve(&self, item: CodeLens, client: LspClient) -> Result<CodeLens> {
        Ok(item)
    }
