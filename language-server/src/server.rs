...
pub trait LanguageServer {
    ...
    #[jsonrpc_method("workspace/didChangeWorkspaceFolders", kind = "notification")]
    ...
    /// is sent from the client to the server before the document is actually saved.
    #[jsonrpc_method("textDocument/willSaveWaitUntil", kind = "request")]
    ...
    #[jsonrpc_method("textDocument/declaration", kind = "request")]
    ...
    #[jsonrpc_method("textDocument/typeDefinition", kind = "request")]
    ...
    #[jsonrpc_method("textDocument/implementation", kind = "request")]
    ...
    #[jsonrpc_method("textDocument/codeLens", kind = "request")]
    async fn code_lens(
        &self,
    ...
    #[jsonrpc_method("codeLens/resolve", kind = "request")]
    ...
    #[jsonrpc_method("documentLink/resolve", kind = "request")]
    ...
    #[jsonrpc_method("textDocument/onTypeFormatting", kind = "request")]
